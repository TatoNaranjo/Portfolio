    ...
    <>
      ...
      >
        <div className="w-full h-2/3 border-b-4 border-black overflow-hidden bg-gray-200">
          {imgSrc && <img src={imgSrc} alt={projectTitle} className="w-full h-full object-cover group-hover:scale-105 grayscale contrast-125 group-hover:grayscale-0 transition-all duration-500" />}
        </div>
